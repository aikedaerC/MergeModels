...
--partition_alpha 0.1 --method lade_real_global --frequency_of_the_test 1 --beta 0.8 \
--model resnet32 --client_num_in_total 100 --client_num_per_round 20 --name C100_RLR --use_lr --debug
```
