...
class TaskVector():
    def __init__(self, pretrained_state_dict=None, finetuned_state_dict=None, vector=None, fintuned_ratio=0.1):
            ...
            with torch.no_grad():
                ...
                for key in pretrained_state_dict:
                    # if pretrained_state_dict[key].dtype in [torch.int64, torch.uint8]:
                        # continue
                    self.vector[key] = fintuned_ratio*finetuned_state_dict[key] - pretrained_state_dict[key]
    ...
    def apply_to(self, pretrained_state_dict, scaling_coef=1.0):
